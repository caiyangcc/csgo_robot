...
public class DaoSupport2 implements DAO {
	 ...
	 * @throws Exception
	 */
	public Object findForWallet(String str, Object obj) throws Exception {
		PageData pageData = new PageData();
		List<PageData> pageDatas = sqlSessionTemplate.selectList(str, obj);
		if (pageDatas != null && pageDatas.size() > 0) {
			pageData = pageDatas.get(0);
		}
		return pageData;
	}

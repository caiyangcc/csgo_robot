	...
	public String getPageStr() {
		...
		if(totalResult>0){
			...
			if(currentPage==1){
				...
				sb.append("	<li><input type=\"number\" value=\""+currentPage+"\" id=\"toGoPage\" style=\"width:50px;text-align:center;float:left\" placeholder=\"页码\"/></li>\n");
